    ...
    public class FacebookChatClient
    {
        ...
        public void Login(string nick, string pass)
        {
            if (!_loggedIn)
                try
                {
                    ...
                    // tyk:
                    /*
                    Subscribe("yongkingteo@hotmail.com");
                    Subscribe("securechat.1@hotmail.com");
                    Subscribe("securechat.2@hotmail.com");
                     */
                }
                catch
                {
        ...
        private void UpdateUserList(object sender, Presence pres)
        {
            ...
            if (pres.Type == PresenceType.available && !Contacts.ContainsKey(pres.From.Bare))
            {
                ...
                // tyk: xcc.MesagageGrabber.Add(new Jid(pres.From.Bare), new BareJidComparer(), new MessageCB(MessageReceived), null);
            ...
            {
                // tyk: xcc.MesagageGrabber.Remove(new Jid(pres.From.Bare));
        ...
        // tyk
        /*
        private void Subscribe(String uid) {
            Jid jid = uid;
            
            xcc.PresenceManager.Subscribe(jid);
        }
         */
